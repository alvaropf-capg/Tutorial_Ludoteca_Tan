...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) //Inicializar contexto Sping cada vez que se inician los test jUnit
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_EACH_TEST_METHOD) //Indica a Spring que los test van a ser transaccionales
public class CategoryIT {
    ...
    //test creacion de una categoria
    ...
    //test prueba erronea (SALE OK EXTRAÑAMENTE, PREGUNTAR)
    @Test
